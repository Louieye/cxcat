<template>
  <div>
    <el-input v-model="search" placeholder="请输入内容" class="searchInput">
    ...
    >
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        ...
        <el-form-item label="课程章节">
          <el-input v-model="form.list" placeholder="请输入一个章节数组" />
        </el-form-item>
        <el-form-item label="状态">
          <el-switch
            v-model="form.onsale"
        ...
        <el-form-item label="教师详情">
          <el-input v-model="form.teacher_d" type="textarea" />
        </el-form-item>
      </el-form>
