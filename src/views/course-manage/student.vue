    ...
    >
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
            <div :key="item" v-for="item in scope.row.classId">
                <div>{{item}}</div>
            </div>
        </template>
      </el-table-column>
      ...
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="课程" prop="classId">
          <el-checkbox-group  v-model="checkList">
            <el-checkbox :key="item.id" v-for="item in classData" :label="item.id">{{item.name}}</el-checkbox>
        </el-checkbox-group>
        </el-form-item>
